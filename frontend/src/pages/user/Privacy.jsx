...
const Privacy = () => {
  return (
    <div
      className="text-[var(--textPrimary)] px-6 py-12 mt-24"
    >
      <div className="max-w-4xl mx-auto bg-backdrop p-8 rounded-lg shadow-md">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <p>
              <strong className="font-semibold">Account</strong> means a unique account created for You to access our Service or parts of
              our Service.
            </p>
          </li>
          <li>
            <p>
              <strong className="font-semibold">Affiliate</strong> means an entity that controls, is controlled by or is under common
          ...
          <li>
            <p>
              <strong className="font-semibold">Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
              &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Statvio.
            </p>
          </li>
          <li>
            <p>
              <strong className="font-semibold">Cookies</strong> are small files that are placed on Your computer, mobile device or any
          ...
          <li>
            <p>
              <strong className="font-semibold">Device</strong> means any device that can access the Service such as a computer, a
              cellphone or a digital tablet.
            </p>
          </li>
          <li>
            <p>
              <strong className="font-semibold">Personal Data</strong> is any information that relates to an identified or identifiable
              individual.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong className="font-semibold">Service Provider</strong> means any natural or legal person who processes the data on
          ...
          <li>
            <p>
              <strong className="font-semibold">Third-party Social Media Service</strong> refers to any website or any social network
              website through which a User can log in or create an account to use the Service.
            </p>
          </li>
          <li>
            <p>
              <strong className="font-semibold">Usage Data</strong> refers to data collected automatically, either generated by the use of
          ...
          <li>
            <p>
              <strong className="font-semibold">You</strong> means the individual accessing or using the Service, or the company, or other
              legal entity on behalf of which such individual is accessing or using the Service, as applicable.
            </p>
          </li>
        </ul>
        <h2 className="text-2xl font-semibold my-6 text-[var(--primary)]">Collecting and Using Your Personal Data</h2>
        ...
        <p className="mb-4">
          Usage Data is collected automatically when using the Service and may include details like IP address,
        ...
        <p className="mb-4">
          We use cookies and similar tracking technologies to enhance your experience. You can learn more about
          our cookie usage by reviewing our Cookies Policy.
        </p>
        <a
          href="/cookies-policy"
        ...
        <p className="mt-4">
          For a full breakdown of data usage, third-party services, and your rights, please review the full policy
          on this page.
        </p>
      </div>
    </div>
